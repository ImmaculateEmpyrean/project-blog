<template>
    <Widget
        mainHeading="Editors Pick" 
        :imagePath="require('@/assets/img/cartagra.jpg')"
        postHeading="Cartagra ~Tsuki Kurui no Yamai~" 
...
<script>
import Widget from '@/components/HomePage/MainFeedWidget/Widget.vue';

export default {
    name: "Cartagra_Latest_MainFeed",
    components:{
        Widget
    }
}
